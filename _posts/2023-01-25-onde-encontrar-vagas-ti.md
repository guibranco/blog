...
<p class="lead">Lista de sites com vagas de emprego para a área de TI — de freelancer a grandes empresas, passando por estágios, repositórios no GitHub e um agregador de vagas em tempo real.</p>

**Índice rápido:**

1. [Freelancer / Autônomo](#freelancer-autonomo)
2. [Estágios](#estagios)
3. [Vagas de TI](#vagas-ti)
4. [Vagas no Geral](#vagas-geral)
5. [Agregador de Vagas](#agregador-vagas)
6. [Repositórios de vagas (GitHub)](#repositorios-vagas-github)
7. [**BÔNUS:** Repositórios com dicas e links (GitHub)](#repositorios-listas-github)

<div class="divider">· · ·</div>

<a id="freelancer-autonomo"></a>
...
Sites que oferecem oportunidades para trabalhos pontuais para profissionais freelancer/autônomos:
...
Sites que oferecem oportunidades de estágio e trainee para estudantes:
...
Sites de vagas de empregos direcionados para a área de tecnologia:
...
Sites gerais de vagas de empregos com boa cobertura para TI:
...
O projeto **Agregador de Vagas** reúne todas as vagas publicadas nos repositórios do GitHub listados abaixo em um único lugar, com API e interface visual:

- [Agregador de Vagas — API (API BR)](https://apibr.com/vagas/swagger/){:target="_blank"}
- [Agregador de Vagas — UI (API BR)](https://apibr.com/ui/vagas/){:target="_blank"}
...
<a id="repositorios-vagas-github"></a>
...
Nas *issues* dos repositórios abaixo são publicadas vagas conforme o nome de cada repositório. Todas estão disponíveis também no [Agregador de Vagas](https://apibr.com/ui/vagas/){:target="_blank"} acima.
...
<a id="repositorios-listas-github"></a>
...
Repositórios no GitHub com links e dicas para quem está procurando emprego na área de TI:
