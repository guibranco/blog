...
locations:
  - lat: 35.9187
    lng: 14.4894
    label: "St. Julian's, Malta"
  - lat: 35.9383
    lng: 14.3436
    label: "Golden Bay, Malta"
  - lat: 35.8256
    lng: 14.5661
    label: "St. Peter's Pool, Malta"
  - lat: 35.8203
    lng: 14.4547
    label: "Blue Grotto, Malta"
  - lat: 36.0125
    lng: 14.3286
    label: "Blue Lagoon, Comino"
  - lat: 35.9122
    lng: 14.5019
    label: "Sliema, Malta"
---
...
<div class="section-header">
  ...
  <div class="section-title-wrap"><h2>Como cheguei: Dublin → Manchester → Malta</h2></div>
</div>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-chegada-01.jpg" class="glightbox" data-gallery="malta-chegada" data-title="<!-- TODO: descrição — chegada em Malta -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-chegada-01.jpg" alt="<!-- TODO: legenda — chegada -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-chegada-02.jpg" class="glightbox" data-gallery="malta-chegada" data-title="<!-- TODO: descrição — chegada em Malta -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-chegada-02.jpg" alt="<!-- TODO: legenda — chegada -->">
  </a>
</div>
...
<table class="compare-table">
  ...
  <tbody>
    ...
    <tr><td>26 → 27/08</td><td>1</td><td>Triplo (3 pessoas)</td><td>€ 202,50</td><td>€ 67,50</td></tr>
    <tr><td>27 → 29/08</td><td>2</td><td>Single (sozinho)</td><td>€ 319,85</td><td>€ 319,85</td></tr>
    <tr><td>Late checkout (29/08)</td><td>2 horas</td><td>—</td><td>€ 30,00</td><td>€ 30,00</td></tr>
    <tr><td><strong>Total</strong></td><td><strong>7</strong></td><td></td><td></td><td><strong>€ 685,68</strong></td></tr>
  </tbody>
</table>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-hotel-01.jpg" class="glightbox" data-gallery="malta-hotel" data-title="<!-- TODO: descrição — ASTE Hotel -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-hotel-01.jpg" alt="<!-- TODO: legenda — ASTE Hotel -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-hotel-02.jpg" class="glightbox" data-gallery="malta-hotel" data-title="<!-- TODO: descrição — piscina da cobertura -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-hotel-02.jpg" alt="<!-- TODO: legenda — piscina da cobertura -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-hotel-03.jpg" class="glightbox" data-gallery="malta-hotel" data-title="<!-- TODO: descrição — vista da varanda -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-hotel-03.jpg" alt="<!-- TODO: legenda — vista da varanda -->">
  </a>
</div>
...
<div class="section-header">
  ...
  <div class="section-title-wrap"><h2>Dia 2 — Golden Bay, Café del Mar e Havana</h2></div>
</div>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia2-01.jpg" class="glightbox" data-gallery="malta-dia2" data-title="<!-- TODO: descrição — Golden Bay -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia2-01.jpg" alt="<!-- TODO: legenda — Golden Bay -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia2-02.jpg" class="glightbox" data-gallery="malta-dia2" data-title="<!-- TODO: descrição — Golden Bay -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia2-02.jpg" alt="<!-- TODO: legenda — Golden Bay -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia2-03.jpg" class="glightbox" data-gallery="malta-dia2" data-title="<!-- TODO: descrição — Café del Mar -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia2-03.jpg" alt="<!-- TODO: legenda — Café del Mar -->">
  </a>
</div>
...
<div class="callout callout-tip">
  ...
  Na volta da Blue Grotto, a corrida saiu por <strong>€ 30</strong> — mas o motorista chegou ao ponto de embarque, viu que estávamos molhados e <strong>recusou a corrida</strong>. Pedi outro na hora e o preço caiu para <strong>€ 18</strong>, com o segundo motorista nos levando sem problema nenhum. Duas lições: leve uma canga ou toalha para se secar antes de chamar o carro, e não aceite o primeiro preço como definitivo — a tarifa oscila bastante conforme a demanda do momento.
</div>
...
<div class="photo-gallery">
  ...
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia3-03.jpg" class="glightbox" data-gallery="malta-dia3" data-title="<!-- TODO: descrição — Blue Grotto -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia3-03.jpg" alt="<!-- TODO: legenda — Blue Grotto -->">
  </a>
</div>
...
<div class="callout callout-warn">
  ...
  Para entrar na Blue Lagoon é necessário retirar um <strong>ingresso gratuito no site blcomino.com</strong> e apresentar o QR code na chegada. É de graça, mas <strong>é obrigatório</strong> — e não é o tipo de coisa que a operadora do passeio necessariamente avisa. Resolva isso antes de embarcar.
</div>
...
<table class="compare-table">
  ...
  <tbody>
    <tr><td>Hoso Maki de salmão (6 unidades)</td><td>€ 4,00</td></tr>
...
<div class="callout callout-tip">
  ...
  Meu amigo tinha combinado de sair com uma maltesa naquele dia, trocou pelo beach club e acabou perdendo o contato dela. Enquanto isso, conhecemos duas finlandesas na festa do branco, elas disseram que iriam para a Toy Room de Paceville e nunca mais soubemos delas. No fim, a noite terminou com as polonesas do barco do dia anterior. Em Malta em agosto, a rotatividade de gente é assim mesmo — <strong>troque contato na hora, não depois</strong>.
</div>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia6-01.jpg" class="glightbox" data-gallery="malta-dia6" data-title="<!-- TODO: descrição — praia rochosa de Sliema -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia6-01.jpg" alt="<!-- TODO: legenda — Sliema -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia6-02.jpg" class="glightbox" data-gallery="malta-dia6" data-title="<!-- TODO: descrição — jantar no UMI -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia6-02.jpg" alt="<!-- TODO: legenda — UMI -->">
  </a>
</div>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia7-01.jpg" class="glightbox" data-gallery="malta-dia7" data-title="<!-- TODO: descrição — piscina da cobertura do ASTE -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia7-01.jpg" alt="<!-- TODO: legenda — piscina -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia7-02.jpg" class="glightbox" data-gallery="malta-dia7" data-title="<!-- TODO: descrição — vista do hotel -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia7-02.jpg" alt="<!-- TODO: legenda — vista -->">
  </a>
</div>
...
<div class="section-header">
  ...
  <div class="section-title-wrap"><h2>Dia 8 — Late checkout, sorvete e a volta</h2></div>
</div>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia8-01.jpg" class="glightbox" data-gallery="malta-dia8" data-title="<!-- TODO: descrição — último dia em St. Julian's -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia8-01.jpg" alt="<!-- TODO: legenda — último dia -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-dia8-02.jpg" class="glightbox" data-gallery="malta-dia8" data-title="<!-- TODO: descrição — aeroporto de Malta -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-dia8-02.jpg" alt="<!-- TODO: legenda — aeroporto -->">
  </a>
</div>
...
<div class="providers-grid">
  <div class="provider-card">
    <div class="provider-name"><i class="fas fa-landmark"></i> Valletta</div>
    <div class="provider-detail">A capital, Patrimônio Mundial da UNESCO, inteira construída pelos Cavaleiros de São João. É a Malta histórica — e é impossível entender a ilha sem ela. As amigas do grupo foram numa manhã/tarde de sexta antes de voltar para Dublin, e isso é aproximadamente o mínimo viável.</div>
    <div class="provider-price">Meio dia a um dia inteiro</div>
  </div>
  <div class="provider-card">
  ...
  <div class="provider-card">
    ...
    <div class="provider-detail">O set de filmagem do Popeye de 1980, preservado e transformado em parque, em Anchor Bay. É turístico e assumidamente kitsch, mas rende fotos que não existem em nenhum outro lugar da Europa.</div>
    <div class="provider-price">Meio dia</div>
  </div>
</div>
...
<div class="callout callout-tip">
  ...
  Sem planejar, a viagem inteira caiu num padrão: <strong>acordar tarde, praia no fim da tarde, jantar tarde e sair à noite</strong>. Não é indisciplina — é o que o clima impõe. Se você montar um roteiro com passeios às 9h da manhã em agosto, ou você não vai cumprir (foi o que aconteceu comigo no Dia 4) ou vai cumprir sofrendo. Planeje as atividades ao ar livre para depois das 16h.
</div>
...
<table class="compare-table">
  ...
  <tbody>
    ...
    <tr><td>24/08</td><td>Café del Mar → Hotel (madrugada)</td><td>€ 30,00</td><td>€ 10,00</td></tr>
...
<div class="photo-gallery">
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-01.jpg" class="glightbox" data-gallery="malta" data-title="<!-- TODO: descrição da foto 1 -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-01.jpg" alt="<!-- TODO: legenda foto 1 -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-02.jpg" class="glightbox" data-gallery="malta" data-title="<!-- TODO: descrição da foto 2 -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-02.jpg" alt="<!-- TODO: legenda foto 2 -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-03.jpg" class="glightbox" data-gallery="malta" data-title="<!-- TODO: descrição da foto 3 -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-03.jpg" alt="<!-- TODO: legenda foto 3 -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-04.jpg" class="glightbox" data-gallery="malta" data-title="<!-- TODO: descrição da foto 4 -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-04.jpg" alt="<!-- TODO: legenda foto 4 -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-05.jpg" class="glightbox" data-gallery="malta" data-title="<!-- TODO: descrição da foto 5 -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-05.jpg" alt="<!-- TODO: legenda foto 5 -->">
  </a>
  <a href="{{ site.baseurl }}/assets/img/posts/malta-2026-06.jpg" class="glightbox" data-gallery="malta" data-title="<!-- TODO: descrição da foto 6 -->">
    <img src="{{ site.baseurl }}/assets/img/posts/malta-2026-06.jpg" alt="<!-- TODO: legenda foto 6 -->">
  </a>
</div>
...
<div class="providers-grid">
  ...
  <div class="provider-card">
    <div class="provider-name"><i class="fas fa-water"></i> St. Peter's Pool</div>
    <div class="provider-detail">Piscina natural de rocha calcária no sudeste, perto de Marsaxlokk. Excelente para pular dos paredões, mas totalmente rochosa — sem areia, sem estrutura, sem espreguiçadeira. Leve água e comida.</div>
    <div class="provider-price">Acesso gratuito · Sem estrutura no local</div>
  </div>
...
<div class="providers-grid">
  ...
  <div class="provider-card">
    <div class="provider-name"><i class="fas fa-plane"></i> Kiwi.com</div>
    <div class="provider-detail">Onde comprei as passagens, com self-transfer em Manchester. Atenção às conexões curtas entre bilhetes separados.</div>
    <div class="provider-price"><a href="https://www.kiwi.com" target="_blank">kiwi.com →</a></div>
  </div>
