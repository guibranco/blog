...
<div class="callout callout-warn">
  <div class="callout-label">Caixas automáticos (ATMs)</div>
  Há centenas de ATMs espalhados pelas cidades, funcionando 24 horas. Os de rua (funcionam como o TecBan brasileiro) costumam cobrar uma taxa de 600 a 800 Leks por saque (≈ € 6–8). O aviso com o valor aparece na tela antes de confirmar a operação. <strong>Prefira sacar um valor alto de uma vez.</strong> ATMs instalados em bancos físicos são, segundo relatos locais, isentos de taxa — vale procurar um em vez de usar os de rua.
</div>
...
Retornamos ao Bianco para buscar o carro. Ligamos para a locadora e, em menos de 1 hora, um eletricista trocou a bateria — sem custo adicional para nós. O seguro da locadora cobriu tudo.
...
<div class="conclusion">
  ...
  <p>A Albânia surpreende em todos os sentidos: praias com água cristalina que rival as melhores da Europa, infraestrutura turística em pleno crescimento, custo-benefício absurdo e um povo receptivo. Sarande e Ksamil são destinos completos — praia de dia, beach clubs à tarde e vida noturna até de madrugada.</p>
